    ...
    public class FearResult : LookupTable
    {
        ...
        public FearResult()
        {
            Map = new Dictionary<int, string>
            {
                ...
                { 115, "[Collapses]- The target collapses into unconsciousness and loses [all of their Fatigue]. After ('30 - Endurance') minutes, or being tended by a Healer, they will regain consciousness. All their Characteristics and Ranks will be reduced by 2, and they will not be able to recover Fatigue, until they have had comfortable bed rest for ('40 - Endurance - tending Healer NodeType') hours. Add '+10' to subsequent rolls on the fright table." },
                { 200, "[Heart Attack]- The target suffers a heart attack and must receive the attention of a Healer of at least 'NodeType 3' within 'Endurance pulses or they are dead'. If they survive they will be on '0 Endurance and 0 Fatigue', and will be unconsciousness for ('30 - Endurance') minutes. All their Characteristics and Ranks will be reduced by 5, and they will not be able to recover Fatigue or more than half their Endurance, until they have had comfortable bed rest for (60 - Endurance - tending Healer NodeType) hours. Add '+10 to subsequent rolls on the fright table'." }
            };
        }
    }
}
