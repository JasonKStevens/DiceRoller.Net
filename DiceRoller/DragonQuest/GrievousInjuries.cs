    ...
    public class GrievousInjuries : LookupTable
    {
        public GrievousInjuries()
        {
            Map = new Dictionary<int, string>
            {
                ...
                { 89, "A jarring blow to your secondary shoulder inflicts 2 Damage Points immediately to Endurance. Roll D10; the result is the number of pulses the arm is useless. You immediately drop anything held in that hand." },
                ...
                { 94, "Your left hip is smashed horribly. Take 5 Damage Points immediately to Endurance and fall prone. You will be unable to walk until the damage has healed (which should take about 6 months). Good fun. When healed, you will still have a limp which will reduce your TMR by 1 and your AG by 2." },
