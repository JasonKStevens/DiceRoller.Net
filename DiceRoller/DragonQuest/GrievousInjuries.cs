...
{
    public class GrievousInjuries
    {
        private static readonly IDictionary<int, string> _injuries = new Dictionary<int, string>
        {
